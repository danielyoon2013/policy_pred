...
# (rustbpe is needed only for training; lazy-import inside train_from_iterator
# so pure-inference setups don't need it on PYTHONPATH. -- policy_pred patch)
import pickle
import tiktoken
...
class RustBPETokenizer:
    ...
    @classmethod
    def train_from_iterator(cls, text_iterator, vocab_size):
        # 1) train using rustbpe (lazy import — only needed during training,
        # see top-of-module note about the policy_pred patch)
        import rustbpe
